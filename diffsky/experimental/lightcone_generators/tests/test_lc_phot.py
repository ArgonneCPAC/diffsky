...
def test_mc_lc_phot_changes_with_diffstarpop(num_halos=20):
    ...
    mc_merge = 0
    phot_kern_results = lc_phot.mc_lc_phot(
        ran_key, lc_data, mc_merge, param_collection=pc1
    )[0]
    phot_kern_results2 = lc_phot.mc_lc_phot(
...
def test_mc_lc_phot_agrees_with_mc_lc_photline(num_halos=20):
    ...
    spec_phot_results = lc_phot.mc_lc_photline(
        ran_key, lc_data, mc_merge, param_collection=pc1
    )
    check_phot_kern_results(phot_kern_results)
...
def test_mc_lc_sed_is_consistent_with_mc_lc_phot(num_halos=5):
    ...
    sed_kern_results = lc_phot.mc_lc_sed(ran_key, lc_data, mc_merge, param_collection=p)
...
def test_mc_lc_dbk_photline(num_halos=20):
    ...
    mc_merge = 0
    dbk_phot_info = lc_phot.mc_lc_dbk_photline(ran_key, lc_data, mc_merge)
...
def test_mc_lc_dbk_sed(num_halos=10):
    ...
    mc_merge = 0
    dbk_sed_info = lc_phot.mc_lc_dbk_sed(ran_key, lc_data, mc_merge)
    rest_sed_sum = (
