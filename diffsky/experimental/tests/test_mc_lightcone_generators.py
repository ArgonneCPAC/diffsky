...
def _get_lc_halos_photdata_for_unit_testing(num_halos=75):
    ran_key = jran.key(0)
    ...
    lc_data = mc_lcg.mc_lc_halos_photdata(*args)

    return lc_data, tcurves


def _get_lc_photdata_for_unit_testing(num_halos=75, n_lines=3):
    ran_key = jran.key(0)
