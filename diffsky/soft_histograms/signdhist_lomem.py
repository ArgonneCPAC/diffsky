...
_nnsig_ndhist_kern_vmap = jjit(vmap(_nnsig_ndhist_kern, in_axes=(0, None, None, None)))
...
_nnsig_ndhist_vmap = jjit(vmap(_nnsig_ndhist_sumkern, in_axes=(None, 0, 0, 0)))
...
_nnsig_ndhist_weighted_sum_vmap = jjit(
    vmap(_nnsig_ndhist_weighted_sum_kern, in_axes=(0, None, 0, None, None))
)
...
_nnsig_ndhist_weighted_vmap = jjit(
    vmap(_nnsig_ndhist_weighted_kern, in_axes=(None, 0, None, 0, 0))
)
