...
from dsps.experimental.diffburst import (
    ...
    _get_params_from_u_params as _get_burstshape_params_from_u_params,
)
...
_get_burstshape_params_from_u_params_vmap = jjit(
    vmap(_get_burstshape_params_from_u_params, in_axes=(0,))
)
...
@jjit
def get_obs_photometry_and_params_singlez(
    ran_key,
    filter_waves,
    filter_trans,
    ssp_obs_photflux_table,
