...
@jjit
def _mc_photline_kern_no_einsum(
    ran_key,
    z_obs,
    t_obs,
    mah_params,
    ...
    phot_kern_results, spec_kern_results = _photline_kern_no_einsum(
        phot_randoms,
        diffstarpop_results,
        z_obs,
        t_obs,
...
def _photline_kern_no_einsum(
    ...
    linelum_q = sspwk._compute_linelum_from_weights_no_einsum(
        phot_kern_results.diffstar_info_q.logsm_obs,
        dust_ftrans_lines_q,
        ssp_data,
        phot_kern_results.burstiness_info_q.ssp_weights_smooth,
    ...
    linelum_ms = sspwk._compute_linelum_from_weights_no_einsum(
        phot_kern_results.diffstar_info_ms.logsm_obs,
        dust_ftrans_lines_ms,
        ssp_data,
        phot_kern_results.burstiness_info_ms.ssp_weights_smooth,
    ...
    linelum_bursty = sspwk._compute_linelum_from_weights_no_einsum(
        phot_kern_results.diffstar_info_ms.logsm_obs,
        dust_ftrans_lines_ms,
        ssp_data,
        phot_kern_results.burstiness_info_ms.ssp_weights_bursty,
