...
def test_compute_photometry(opencosmo_data_path, version_checking):
    bands = ("lsst_u", "lsst_g", "lsst_r", "lsst_i", "lsst_z", "lsst_y")
    catalog, aux_data = load_diffsky_mock(
        opencosmo_data_path, version_check=version_checking
    )
...
def test_compute_photometry_with_batch(opencosmo_data_path, version_checking):
    bands = ("lsst_u", "lsst_g", "lsst_r", "lsst_i", "lsst_z", "lsst_y")
    catalog, aux_data = load_diffsky_mock(
        opencosmo_data_path, version_check=version_checking
    )
...
def test_compute_photometry_custom_bands(opencosmo_data_path, version_checking):
...
def test_compute_photometry_custom_bands_insert(opencosmo_data_path, version_checking):
    wave = np.linspace(200, 8_000, 500)
    fake_tcurve1 = jnorm.pdf(wave, loc=3_000.0, scale=500.0)
    fake_tcurve2 = jnorm.pdf(wave, loc=5_000.0, scale=500.0)
...
def test_compute_dbk_photometry(opencosmo_data_path, version_checking):
    bands = ("lsst_u", "lsst_g", "lsst_r", "lsst_i", "lsst_z", "lsst_y")
    catalog, aux_data = load_diffsky_mock(
        opencosmo_data_path, version_check=version_checking
    )
...
def test_compute_seds(opencosmo_data_path, version_checking):
    bands = ("lsst_u", "lsst_g", "lsst_r", "lsst_i", "lsst_z", "lsst_y")
    catalog, aux_data = load_diffsky_mock(
        opencosmo_data_path, version_check=version_checking
    )
...
def test_compute_seds_with_batching(opencosmo_data_path, version_checking):
    bands = ("lsst_u", "lsst_g", "lsst_r", "lsst_i", "lsst_z", "lsst_y")
    catalog, aux_data = load_diffsky_mock(
        opencosmo_data_path, version_check=version_checking
    )
...
def test_compute_seds_insert(opencosmo_data_path, version_checking):
    bands = ("lsst_u", "lsst_g", "lsst_r", "lsst_i", "lsst_z", "lsst_y")
    catalog, aux_data = load_diffsky_mock(
        opencosmo_data_path, version_check=version_checking
    )
...
def test_compute_dbk_seds(opencosmo_data_path, version_checking):
    bands = ("lsst_u", "lsst_g", "lsst_r", "lsst_i", "lsst_z", "lsst_y")
    catalog, aux_data = load_diffsky_mock(
        opencosmo_data_path, version_check=version_checking
    )
