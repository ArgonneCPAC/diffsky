...
python scripts/LJ_LC_MOCKS/make_ou25_mock.py  poboy 0.01 0.5 0 1 ci_test_output ci_test_mock -fn_u_params sfh_model -sfh_model smdpl_dr1 -synthetic_cores 1 -lgmp_min 11.5 -lgmp_max 13.5

python scripts/LJ_LC_MOCKS/make_ou25_mock.py  poboy 0.08 0.1 0 1 ci_test_output ci_test_mock -fn_u_params sfh_model -sfh_model smdpl_dr1 -synthetic_cores 1 -lgmp_min 12.5 -lgmp_max 13.5
