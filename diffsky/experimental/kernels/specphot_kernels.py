...
from . import linelum_kernels_in_situ, shambalam, mc_randoms
...
def _specphot_kern_merging(
    ...
    _res = shambalam._get_phot_kern_merging_quantities(
        phot_kern_results,
        merging_randoms,
        p_merge_smooth,
        sat_weights,
    ...
    func = shambalam._update_phot_kern_results_with_merging
