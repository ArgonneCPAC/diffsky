...
def _mc_dbk_phot_kern_einsum(
    ...
    dbk_phot_info, dbk_weights = _dbk_phot_kern_einsum(
        phot_randoms,
        diffstarpop_results,
        dbk_randoms,
        z_obs,
...
def _dbk_phot_kern_einsum(
    ...
    _ret3 = dbk_kernels._get_dbk_phot_from_dbk_weights_einsum(
        phot_kern_results.ssp_photflux_table,
        dbk_weights,
        phot_kern_results.dust_frac_trans,
        phot_kern_results.frac_ssp_errors,
