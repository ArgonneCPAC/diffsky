...
def _mc_phot_kern_einsum(
    ...
    *,
    ...
    phot_kern_results = _phot_kern_einsum(
        phot_randoms,
        diffstarpop_results,
        z_obs,
        t_obs,
...
def _phot_kern_einsum(
    ...
    *,
    ...
    obs_mags_mc = sspwk._compute_obs_mags_from_weights_einsum(
        diffstar_info_mc.logsm_obs,
        dust_frac_trans_mc,
        frac_ssp_errors_mc,
        ssp_photflux_table,
    ...
    obs_mags_ms = sspwk._compute_obs_mags_from_weights_einsum(
        diffstar_info_ms.logsm_obs,
        dust_frac_trans_ms,
        frac_ssp_errors_ms,
        ssp_photflux_table,
    ...
    obs_mags_q = sspwk._compute_obs_mags_from_weights_einsum(
        diffstar_info_q.logsm_obs,
        dust_frac_trans_q,
        frac_ssp_errors_q,
        ssp_photflux_table,
    ...
    obs_mags_bursty = sspwk._compute_obs_mags_from_weights_einsum(
        diffstar_info_ms.logsm_obs,
        dust_frac_trans_ms,
        frac_ssp_errors_ms,
        ssp_photflux_table,
